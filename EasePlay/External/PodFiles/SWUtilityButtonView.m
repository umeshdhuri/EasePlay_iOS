...
- (void)setUtilityButtons:(NSArray *)utilityButtons
{
   ...
   // [self setUtilityButtons:utilityButtons WithButtonWidth:kUtilityButtonWidthDefault spaceVal:<#(int)#>];
}

- (void)setUtilityButtons:(NSArray *)utilityButtons WithButtonWidth:(CGFloat)width spaceVal:(int) space
{
    ...
    self.widthConstraint.constant = (width * utilityButtons.count) + space;
